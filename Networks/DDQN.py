...
class Model(nn.Module):
    ...
    and 2 flat layers. The model also contains a final flat layer that outputs the
    ...
    @return the values of possible actions in the state
    """
    def forward(self, state):
        ...
        ## Actions from forward pass
        actions = self.A(flatTwo)
